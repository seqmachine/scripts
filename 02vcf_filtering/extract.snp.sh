...
zcat $input |awk '{if ($6=="exonic") print $0}' | grep -v -w  "synonymous" | grep -v unknown >$input".fun"
...
cat <(cat $file | awk -F "\t" '{if ($12 !="." && $12 <0.005 && $15=="D") print $0}') \
<(cat $file | awk -F "\t" '{if ($12 !="." && $12 >0.995 && $15=="D") print $0}') \
<(cat $file | awk -F "\t" '{if ($12 =="." && $15=="D") print $0}') > $file".pdv"
