...
#samtools mpileup -f ~/02databases/bwa_indexes/hg19.fa -r chr10:1046966-1047000  GSM1254204_hESC_H1_PacBio.fa.gz.1.bam.sorted.rmdup SRR1020625.bam.sorted.rmdup 
