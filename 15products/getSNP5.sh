...
#mom.ht01
ptype=$4
#July1, 2019 different products, HT01, SK02

if [ $ptype == "ht01" ]
then
	echo "we are genotyping SNC product HT01..."
...
python /home/tianr/pipelines/getSNP/correctMinusStrand.py $name".xls" $ptype>$name".adj.xls"
